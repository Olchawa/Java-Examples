...
class GameDrawingPanel2 extends JComponent { 
	...
	public void paint(Graphics g) { 
		...
		if (GameBoard.keyHeld == true && GameBoard.keyHeldCode == 87){
			...
			theShip.increaseXVelocity(theShip.shipXMoveAngle(theShip.getMovingAngle())*0.2);
			theShip.increaseYVelocity(theShip.shipYMoveAngle(theShip.getMovingAngle())*0.2);
		...
		if (GameBoard.keyHeld == true && GameBoard.keyHeldCode == 83){
			...
			theShip.decreaseXVelocity(theShip.shipXMoveAngle(theShip.getMovingAngle())*0.2);
			theShip.decreaseYVelocity(theShip.shipYMoveAngle(theShip.getMovingAngle())*0.2);
